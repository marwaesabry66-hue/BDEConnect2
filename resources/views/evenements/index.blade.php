        ...
        <tbody>
            ...
            <tr class="border-t hover:bg-gray-50">
                ...
                <td class="px-4 py-3 flex gap-2">
                    <a href="{{ route('evenements.export', $evenement) }}" class="bg-green-600 text-white px-3 py-1 rounded text-sm hover:bg-green-700">
                        Exporter CSV
                    </a>

                    <a href="{{ route('evenements.edit', $evenement) }}" class="bg-yellow-400 text-white px-3 py-1 rounded text-sm hover:bg-yellow-500">
                        Modifier
                    </a>
            ...
            @empty
            <tr>
                <td colspan="5" class="px-4 py-6 text-center text-gray-500">Aucun événement.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
